...
export const locations = [
  {
    ...
    governorate: "Cairo",
    address: "Third Residential Neighborhood, Oasis Area — R3-os-s08",
    landmarks: ["Overlooking the highway", "3 min from New Administrative Capital Authority"],
  ...
  },
  {
    ...
    address: "Plot No. 8 — Entertainment District, Obour City, Qalyubia Governorate",
    landmarks: ["Prime location in the Entertainment District", "1 min from Prime housing & main roads", "1 min from Al-Obour Sports Club"],
  ...
  },
  {
    ...
    governorate: "Giza",
    address: "City Center 2 — 6th of October City, Giza Governorate",
    landmarks: ["Distinguished location overlooking Al Wahat Road", "Front of Jannat Al Shorouk Compound", "5 min from MSA University"],
  ...
  },
  {
    ...
    tag: "Community",
    gla: "13,841 m²",
    totalArea: "13,841.82 m²",
    retail: "Building A: 681 m² · B: 181 m² · C: 3,014 m²",
    fnb: "Building A: 611 m² · B: 181 m² · C: 2,400 m²",
    fnbUnits: 0,
    hypermarket: "—",
    parking: "—",
    brands: "30+",
    ...
    city: "Nasr City",
    governorate: "Cairo",
    address: "Al Mithaq Road, 10th District, Nasr City, Cairo",
    landmarks: ["5 min from Zahraa Nasr City's new club", "1 min from Zahraa Nasr City's new Apartment complex"],
  ...
  },
  {
    ...
    governorate: "Cairo",
    address: "13 acres area — Southern entrance, 15th of May City, Cairo Governorate",
    landmarks: ["Overlooking the highway", "1 min from Al Hashem Compound"],
  ...
  },
  {
    ...
    city: "Badr City",
    governorate: "Cairo",
    address: "First Neighborhood, Third District — Badr City, Cairo Governorate",
    landmarks: ["Distinguished location in the Jasmine neighborhood", "10 min from Badr City Development Authority"],
  ...
  },
  {
    ...
    governorate: "Cairo",
    address: "City Center 2 — Shorouk City, Cairo Governorate",
    landmarks: ["Overlooking Mubarak Housing Street", "Front of Jannat Al Shorouk Compound", "10 min from Valu Mall"],
    mapUrl: "https://maps.google.com/?q=C3+Mall+Shorouk+Egypt",
    description: "A vibrant community retail destination in El Shorouk City's Greater Cairo eastern corridor.",
  },
  {
    id: "10-ramadan",
    ...
    governorate: "Sharkia",
    address: "Plot No. 44 — City Services Center, 10th of Ramadan City, Sharqia Governorate",
    landmarks: ["1 min from Main Road", "1 min from Electricity Company", "1 min from Diamond Hotel"],
    mapUrl: "https://maps.google.com/?q=C3+Mall+10+Ramadan+Egypt",
    description: "Expanding the C3 network beyond Greater Cairo into Sharkia's 10th of Ramadan City — Egypt's industrial heartland.",
  },
];
